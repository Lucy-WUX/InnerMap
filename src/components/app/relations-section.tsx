  ...
  return (
    <section className="grid gap-ds-md lg:grid-cols-[320px_1fr]">
      ...
      <aside className="space-y-ds-xs">
        <Card className="rounded-ds border border-warm-base bg-paper p-ds-lg dark:border-[var(--pss-border-subtle)]">
          <h3 className="text-ds-title dark:text-[var(--pss-text-primary)]">关系健康度</h3>
          {hasContacts ? (
            <div className="mt-ds-xs flex items-center gap-ds-md">
              ...
              >
                ...
                />
                <div className="absolute inset-[14px] flex items-center justify-center rounded-full bg-white text-center dark:bg-[var(--pss-surface-muted)]">
                  {activeHealth ? (
                    <div className="-translate-y-0.5 leading-tight">
                      <p className="text-ds-caption text-soft dark:text-[var(--pss-text-muted)]">{activeHealth.label}</p>
                      <p className="text-lg font-semibold text-ink dark:text-[var(--pss-text-primary)]">{activeHealth.count}</p>
                    </div>
                  ) : (
                    <div className="-translate-y-0.5 leading-tight">
                      <p className="text-ds-caption text-soft dark:text-[var(--pss-text-muted)]">总联系</p>
                      <p className="text-lg font-semibold text-ink dark:text-[var(--pss-text-primary)]">{contacts.length}</p>
                    </div>
                  )}
                </div>
              </div>
              <div className="flex-1 space-y-ds-xs">
                {relationHealthData.map((item, index) => (
                  <div
                    key={item.label}
                    className="rounded-md px-1 py-0.5 transition-colors duration-200 hover:bg-surface-warm-hover dark:hover:bg-[var(--pss-surface-muted)]"
                  ...
                  >
                    <div className="flex items-center justify-between text-ds-caption text-soft dark:text-[var(--pss-text-muted)]">
            ...
            <div className="mt-ds-xs rounded-ds border border-dashed border-warm-soft bg-surface-warm-soft px-3 py-4 text-ds-caption text-soft dark:border-[var(--pss-border-mid)] dark:bg-[var(--pss-elevated)] dark:text-[var(--pss-text-muted)]">
              <p>暂无联系人时，健康度保持空白。</p>
              <p className="mt-1">添加第一位联系人后，会显示分布与趋势。</p>
            </div>
          )}
          <div className="mt-ds-xs rounded-ds border border-warm-soft bg-surface-warm-soft px-3 py-2 text-ds-caption text-[#5c4d42] dark:border-[var(--pss-border-mid)] dark:bg-[var(--pss-elevated)] dark:text-[var(--pss-text-body)]">
            {!hasContacts ? (
        ...
        <Card className="rounded-ds border border-warm-base bg-paper p-ds-lg dark:border-[var(--pss-border-subtle)]">
          <h3 className="text-ds-title dark:text-[var(--pss-text-primary)]">⚡ 近期能量消耗</h3>
              ...
              <div
                ...
                className={`flex items-start gap-ds-xs rounded-ds border p-ds-xs ${
                  item.alert
                    ...
                    : "border-warm-soft dark:border-[var(--pss-border-subtle)] dark:bg-[var(--pss-surface-inset)]"
                }`}
              >
                <button
                ...
                >
                  ...
                  <p className="mt-1 text-ds-caption text-soft dark:text-[var(--pss-text-muted)]">{item.desc}</p>
                </button>
                <button
                  className="rounded-btn-ds border border-warm-soft px-1.5 py-1 text-ds-caption hover:bg-surface-warm-soft dark:border-[var(--pss-border-mid)] dark:hover:bg-[var(--pss-surface-muted)]"
                  title="快捷记录互动"
      ...
      <div className="space-y-ds-xs">
        <div className="rounded-ds border border-warm-base bg-paper p-ds-lg dark:border-[var(--pss-border-subtle)] dark:bg-[var(--pss-surface-card)]">
          <div className="flex items-center justify-between">
            <h3 className="text-ds-title dark:text-[var(--pss-text-primary)]">联系人概览</h3>
          ...
          <div className="mt-ds-xs flex flex-wrap items-center gap-ds-xs">
            <input
              className="w-56 rounded-btn-ds border border-warm-soft bg-paper px-2 py-1 text-ds-caption dark:border-[var(--pss-border-mid)] dark:bg-[var(--pss-surface-inset)] dark:text-[var(--pss-text-body)] dark:placeholder:text-[var(--pss-text-faint)]"
              placeholder="搜索姓名/分组/标签"
              value={relationsSearchQuery}
              onChange={(e) => setRelationsSearchQuery(e.target.value)}
            />
            <select
              className="rounded-btn-ds border border-warm-soft bg-paper px-2 py-1 text-ds-caption dark:border-[var(--pss-border-mid)] dark:bg-[var(--pss-surface-inset)] dark:text-[var(--pss-text-body)]"
            ...
            <button
              className={`rounded-btn-ds border px-2 py-1 text-ds-caption ${
                bulkMode
                  ...
                  : "border-warm-soft bg-paper text-soft dark:border-[var(--pss-border-mid)] dark:bg-[var(--pss-surface-card)] dark:text-[var(--pss-text-muted)]"
              }`}
              onClick={() => {
                setBulkMode((prev) => {
                  const next = !prev
            ...
            {bulkMode ? (
              <>
                <button
                  className="rounded-btn-ds border border-warm-soft px-2 py-1 text-ds-caption dark:border-[var(--pss-border-mid)] dark:text-[var(--pss-text-body)] dark:hover:bg-[var(--pss-surface-muted)]"
                  onClick={() => {
          ...
          <div className="mt-ds-xs flex flex-wrap gap-ds-xs">
            <button
                ...
                relationsFocusGroup === "全部"
                  ? "border-[#b6905e] bg-[#fff3dc] text-[#7a5a2e] dark:border-amber-700/50 dark:bg-amber-950/40 dark:text-amber-100"
                  : "border-warm-soft bg-surface-warm-soft text-muted dark:border-[var(--pss-border-mid)] dark:bg-[var(--pss-surface-muted)] dark:text-[var(--pss-text-muted)]"
              }`}
            ...
            {allGroups.map((group) => {
              ...
              return (
                ...
                >
                  ...
                  {canManage ? (
                    <div
                      className="relative flex shrink-0 border-l border-[#e7dfd4] dark:border-[var(--pss-border-mid)]"
                      ref={openMenuFor === group ? menuRef : undefined}
                    >
                      <button
                        type="button"
                        className="flex h-full w-8 items-center justify-center text-[#6d5e54] hover:bg-black/[0.04] dark:text-[var(--pss-text-muted)] dark:hover:bg-white/5"
                      ...
                      {openMenuFor === group ? (
                        <div className="absolute right-0 top-full z-30 mt-1 min-w-[8.5rem] rounded-ds border border-warm-soft bg-paper py-1 shadow-ds-card dark:border-[var(--pss-border-mid)] dark:bg-[var(--pss-surface-card)] dark:shadow-[0_8px_24px_rgba(0,0,0,0.45)]">
                          <button
                            type="button"
                            className="block w-full px-3 py-2 text-left text-ds-caption hover:bg-surface-warm-soft dark:hover:bg-[var(--pss-surface-muted)]"
                            onClick={() => {
                              setRenameFrom(group)
        ...
        <div className="rounded-ds border border-warm-base bg-paper p-ds-lg dark:border-[var(--pss-border-subtle)] dark:bg-[var(--pss-surface-card)]">
          <div className="mb-3 flex items-center justify-between">
            <p className="text-ds-caption text-soft dark:text-[var(--pss-text-muted)]">已显示 {relationVisibleContacts.length} 位联系人</p>
            <p className="hidden text-ds-caption text-soft dark:text-[var(--pss-text-faint)] sm:block">点击卡片查看详情与 AI 建议</p>
          </div>
          {relationVisibleContacts.length === 0 ? (
            <div className="rounded-ds border border-dashed border-warm-soft bg-surface-warm-soft p-ds-md dark:border-[var(--pss-border-mid)] dark:bg-[var(--pss-elevated)]">
              {contacts.length === 0 ? (
                <div className="space-y-2">
                  <p className="text-ds-body font-medium text-ink dark:text-[var(--pss-text-primary)]">还没有联系人，从这里开始更清晰：</p>
                  <p className="text-ds-caption text-soft dark:text-[var(--pss-text-muted)]">建议顺序：先新建联系人 → 再建分组 → 然后记录一次互动。</p>
                ...
                <p className="text-ds-body text-soft dark:text-[var(--pss-text-muted)]">当前筛选条件下暂无联系人，请切换筛选或搜索关键词。</p>
              )}
            </div>
          ) : (
            <div className="grid gap-ds-xs md:grid-cols-2">
              {relationVisibleContacts.map((c) => (
                <div
                  key={c.id}
                  className="group relative w-full cursor-pointer rounded-xl border border-transparent bg-surface-warm-soft p-3 text-left shadow-ds-card transition-all duration-200 hover:-translate-y-0.5 hover:border-warm-soft/50 hover:bg-[#f2e8db] hover:shadow-ds-card-hover active:translate-y-0 active:border-warm-soft/60 active:bg-[#dfd3c4] active:shadow-[inset_0_2px_8px_rgba(80,60,40,0.08)] motion-reduce:transition-none motion-reduce:hover:translate-y-0 dark:border-[var(--pss-border-subtle)] dark:bg-[var(--pss-surface-inset)] dark:shadow-none dark:hover:border-[var(--pss-border-mid)] dark:hover:bg-[var(--pss-surface-muted)]/80 dark:active:border-[var(--pss-border-mid)] dark:active:bg-[var(--pss-surface-muted)] dark:active:shadow-[inset_0_2px_8px_rgba(0,0,0,0.35)]"
                  onClick={() => openPage4WithContact(c.id)}
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex flex-1 items-center gap-2 rounded-btn-ds p-1">
                      <span className="flex h-8 w-8 items-center justify-center rounded-btn-ds bg-[#efe4d3] text-ds-caption text-soft dark:bg-[var(--pss-surface-muted)] dark:text-[var(--pss-text-body)]">
                        {c.name.slice(0, 1)}
                      </span>
                      <div>
                        <p className="text-ds-body font-medium dark:text-[var(--pss-text-primary)]">{c.name}</p>
                        <div className="mt-1 w-20">
                          <div className="h-1.5 rounded-full bg-[#eadfce] dark:bg-[var(--pss-surface-muted)]">
                            <div
                          ...
                          <p className="mt-0.5 text-ds-caption text-muted dark:text-[var(--pss-text-muted)]">真心 {c.trueFriendScore.toFixed(1)}/10</p>
                        </div>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="rounded-btn-ds bg-[#f8f1e8] px-2 py-0.5 text-ds-caption text-muted dark:bg-[var(--pss-surface-muted)] dark:text-[var(--pss-text-body)]">
                        {c.group}
                      </span>
                      {bulkMode ? (
                        <button
                          className={`flex h-6 w-6 items-center justify-center rounded-full border text-[10px] ${
                            selectedRelationIds.includes(c.id)
                              ...
                              : "border-warm-soft bg-paper text-soft dark:border-[var(--pss-border-mid)] dark:bg-[var(--pss-surface-muted)] dark:text-[var(--pss-text-body)]"
                          }`}
                          onClick={(e) => {
                            e.preventDefault()
                            e.stopPropagation()
                        ...
                        <div className="relative" data-contact-menu={c.id}>
                          <button
                            type="button"
                            className="flex h-7 w-7 items-center justify-center rounded-btn-ds text-soft transition-colors hover:bg-[#f5e9d9] dark:text-[var(--pss-text-muted)] dark:hover:bg-[var(--pss-surface-muted)]"
                            onClick={(e) => {
                              e.stopPropagation()
                          ...
                          {openContactMenuFor === c.id ? (
                            <div
                              className="absolute right-0 top-full z-30 mt-1 min-w-[8.5rem] rounded-ds border border-warm-soft bg-paper py-1 shadow-ds-card dark:border-[var(--pss-border-mid)] dark:bg-[var(--pss-surface-card)] dark:shadow-[0_8px_24px_rgba(0,0,0,0.45)]"
                  ...
                  <p className="mt-ds-xs line-clamp-2 text-ds-caption text-soft dark:text-[var(--pss-text-muted)]">💬 {c.note}</p>
                  <div className="mt-1 flex items-center justify-between">
                    <p className="text-ds-caption text-muted dark:text-[var(--pss-text-faint)]">
                      最近联系：{c.lastContact?.trim() ? c.lastContact : "暂未联系"}
                    </p>
                    {!bulkMode ? (
                      <button
                        type="button"
                        className="rounded-btn-ds border border-warm-soft bg-paper/80 px-2 py-1 text-ds-caption text-soft transition-colors hover:bg-[#f5e9d9] dark:border-[var(--pss-border-mid)] dark:bg-[var(--pss-surface-muted)] dark:text-[var(--pss-text-body)] dark:hover:bg-[var(--pss-surface-card)]"
                        onClick={(e) => {
                          e.stopPropagation()
